...
```{r disaster-hist, fig.alt="Density plot of natural disasters. Shows increase from 1950 to present"}
disaster_data %>%
...
```{r recent_co2, fig.alt="Mauna Loa CO2 levels (ppm) of last 60 years. Shows seasonal variability and distinct exponential increase."}
global_co2 %>%
...
```{r global_co2, fig.alt="Global CO2 levels (ppm) of last 800 thousand years from ice cores. Big spike at onset of industrial revolution and still rising today."}
global_co2 %>%
