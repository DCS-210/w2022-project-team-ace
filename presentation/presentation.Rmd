...
.pull-right[
* Most of our data comes from Kaggle

* We combined sea level, temperature, disaster, population, and geographic data 
for our plots
...
.pull-right[
```{r linegraph of disasters, echo = FALSE}
...
- Since the industrial revolution we are now at the highest CO2 level(ppm) in Earth's history
]
